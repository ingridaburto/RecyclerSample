...
class FlowerDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val flowerTamanio: TextView = findViewById(R.id.tvTamanio)
        val flowerTemporada: TextView = findViewById(R.id.tvTemporada)
        ...
        currentFlowerId?.let {
            ...
            flowerTamanio.text = currentFlower?.tamanio
            flowerTemporada.text = currentFlower?.temporada
